...
const sheetID = "1w2nMsC7e7gwwCf7HdYWjc1wDvjMuJe7SPeXTwkMNl3o";
      ...
      .then(response => {
        ...
        response.data.feed.entry.forEach(item => {
          data.content.push({
            ...
            "nickname": item["gsx$chiseiticonsigliamodinonusareiltuonomeecognomescrivisoloilnomeoscegliunnickname."].$t,
        ...
        seed(JSON.stringify(data,null,2), `${__dirname}/../dev/sheet.json`);
        seed(JSON.stringify(response.data.feed,null,2), `${__dirname}/../dev/feed.json`);
